            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    ...
                    <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                        ...
                        <?php
                        if (isset($_SESSION["user_id"])) { ?>
                        <a href="" class="btn btn-lg btn-outline-light mt-3 mt-md-5 py-md-3 px-md-5">Check Out Our Tips</a>
                        <?php } ?>
    ...
    <div class="row px-3">
        <div class="col-md-6 p-0">
            <div class="gym-class-box d-flex flex-column align-items-end justify-content-center bg-primary text-right text-white py-5 px-5">
                ...
                <h3 class="display-4 mb-3 text-white font-weight-bold">Body Transformation</h3>
                <p>
        ...
        <div class="col-md-6 p-0">
            <div class="gym-class-box d-flex flex-column align-items-start justify-content-center bg-secondary text-left text-white py-5 px-5">
                ...
                <h3 class="display-4 mb-3 text-white font-weight-bold">Strength & Conditioning</h3>
                <p>
...
<div class="container py-5">
    <div class="row align-items-center">
        ...
        <div class="col-lg-6">
            <h2 class="display-4 font-weight-bold mb-4">10 Years of Excellence in Fitness</h2>
            <p>
                Our gym is built on a foundation of strength, passion, and commitment. For over a decade, we’ve helped members transform their bodies, build confidence, and achieve their fitness goals with expert guidance and top-tier facilities.
            </p>
            <div class="row py-2">
                <div class="col-sm-6">
                    <i class="flaticon-barbell display-2 text-primary"></i>
                    <h4 class="font-weight-bold">Certified Training Facility</h4>
                    <p>
                        Our gym is equipped with state-of-the-art machines, free weights, and functional training zones, ensuring the best training experience for all fitness levels.
                    </p>
                </div>
                <div class="col-sm-6">
                    <i class="flaticon-medal display-2 text-primary"></i>
                    <h4 class="font-weight-bold">Award-Winning Fitness Center</h4>
                    <p>
                        Recognized for excellence in fitness training, we take pride in delivering results through professional coaching, innovative workouts, and a strong community atmosphere.
                    </p>
                </div>
            </div>
        ...
        <div class="col-lg-4 p-0">
            <div class="d-flex align-items-center bg-secondary text-white px-5" style="min-height: 300px;">
                ...
                <div class="">
                    ...
                    <p>
                        At our gym, we focus on continuous improvement. Whether you're a beginner or an advanced athlete, our structured programs ensure you break limits and achieve your fitness goals with measurable progress.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 p-0">
            <div class="d-flex align-items-center bg-primary text-white px-5" style="min-height: 300px;">
                ...
                <div class="">
                    ...
                    <p>
                        Train with the best equipment, expert trainers, and a motivating atmosphere. Whether you're into strength training, bodybuilding, or functional fitness, we provide the perfect space to push your limits.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-lg-4 p-0">
            <div class="d-flex align-items-center bg-secondary text-white px-5" style="min-height: 300px;">
                ...
                <div class="">
                    ...
                    <p>
                        Fitness isn’t just about lifting weights—it’s also about fueling your body the right way. We offer personalized nutrition advice to help you maximize results, improve recovery, and build a healthier lifestyle.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="row">
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-sm-7">
                    <h4 class="font-weight-bold">Expert Video Guidance</h4>
                    <p>
                        Access high-quality instructional videos from our certified trainers, helping you perfect your form, learn new exercises, and stay motivated throughout your fitness journey.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-sm-7">
                    <h4 class="font-weight-bold">Personalized Training Plans</h4>
                    <p>
                        Stay on track with customized training schedules tailored to your fitness level and goals. Whether it's weight loss, muscle gain, or endurance, we provide structured plans for success.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-sm-7">
                    <h4 class="font-weight-bold">Free Fitness Apps & WiFi</h4>
                    <p>
                        Stay connected and track your progress with our exclusive fitness app. Enjoy free WiFi access, allowing you to stream workouts, track your stats, and stay engaged with your fitness journey.
                    </p>
                </div>
            </div>
        </div>
        <div class="col-md-6 mb-5">
            <div class="row align-items-center">
                ...
                <div class="col-sm-7">
                    <h4 class="font-weight-bold">Supportive Fitness Community</h4>
                    <p>
                        Join a gym that feels like family! Our community-driven environment ensures you stay motivated with group classes, fitness challenges, and 24/7 trainer support.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-6">
                <div class="pr-md-3 d-none d-md-block">
                    ...
                    <p class="m-0 text-white">
                        Body Mass Index (BMI) is a widely used measure to assess whether your weight is within a healthy range for your height. While it doesn’t measure muscle mass directly, it helps you understand your fitness level and track your progress towards a healthier lifestyle.
                    </p>
                </div>
            </div>
                ...
                <div class="py-5 px-3">
                    ...
                    <form>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col form-group">
                                <select class="custom-select custom-select-lg bg-dark text-white">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <input type="button" class="btn btn-lg btn-block btn-dark border-light" value="Calculate Now">
                            </div>
                        </div>
                    </form>
                </div>
        ...
        <div class="row px-3 align-items-center">
                        ...
                        <div class="carousel-inner" role="listbox">
                            <div class="carousel-item active">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    ...
                                    <div class="pl-4">
                                        <h4 class="text-primary">Alex Johnson</h4>
                                        <p class="m-0">Fitness Enthusiast</p>
                                    </div>
                                </div>
                                <div class="testimonial-text position-relative border bg-dark text-white mb-5 p-4">
                                    "I've never felt stronger or more confident. The trainers here are truly experts, and the atmosphere keeps me motivated every day!"
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    ...
                                    <div class="pl-4">
                                        <h4 class="text-primary">Sophia Martinez</h4>
                                        <p class="m-0">Yoga Instructor</p>
                                    </div>
                                </div>
                                <div class="testimonial-text position-relative border bg-dark text-white mb-5 p-4">
                                    "The variety of training options and the support from the community here are amazing. Whether it’s strength training or yoga, I find everything I need!"
                                </div>
                            </div>
                            <div class="carousel-item">
                                <div class="d-flex align-items-center mb-4 text-white">
                                    ...
                                    <div class="pl-4">
                                        <h4 class="text-primary">David Williams</h4>
                                        <p class="m-0">Professional Athlete</p>
                                    </div>
                                </div>
                                <div class="testimonial-text position-relative border bg-dark text-white mb-5 p-4">
                                    "This gym provides top-tier equipment, expert trainers, and an incredible atmosphere for pushing your limits. Highly recommended for anyone serious about fitness!"
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-6">
                <div class="pl-md-3 d-none d-md-block">
                    ...
                    <p class="m-0 text-white">
                        We take pride in providing an environment where our members can thrive. From beginners to elite athletes, everyone finds the motivation, support, and resources they need to achieve their fitness goals.
                    </p>
                </div>
            </div>
        </div>
...
<div class="container pt-5">
    <div class="d-flex flex-column text-center mb-5">
        ...
        <h4 class="display-4 font-weight-bold">Latest Fitness Tips & Updates</h4>
    </div>
    <div class="row">
        <div class="col-lg-6 mb-5 blog-item">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="pl-3">
                    <h3 class="font-weight-bold">5 Essential Exercises for Strength Training</h3>
                    <div class="d-flex">
                        <small class="mr-2 text-muted"><i class="fa fa-user"></i> Admin</small>
                        <small class="mr-2 text-muted"><i class="fa fa-folder"></i> Strength Training</small>
                        <small class="mr-2 text-muted"><i class="fa fa-comments"></i> 20 Comments</small>
                    </div>
                </div>
            </div>
            <p>
                Strength training is key to building muscle and improving endurance. In this article, we break down the top five exercises that every fitness enthusiast should include in their routine for maximum gains.
            </p>
        ...
        <div class="col-lg-6 mb-5 blog-item">
            ...
            <div class="d-flex align-items-center mb-4">
                ...
                <div class="pl-3">
                    <h3 class="font-weight-bold">The Truth About Nutrition & Muscle Growth</h3>
                    <div class="d-flex">
                        <small class="mr-2 text-muted"><i class="fa fa-user"></i> Admin</small>
                        <small class="mr-2 text-muted"><i class="fa fa-folder"></i> Nutrition</small>
                        <small class="mr-2 text-muted"><i class="fa fa-comments"></i> 18 Comments</small>
                    </div>
                </div>
            </div>
            <p>
                Nutrition plays a crucial role in muscle development. Learn the do’s and don’ts of a proper diet to fuel your workouts, optimize recovery, and accelerate muscle growth effectively.
            </p>
            <a class="btn btn-outline-primary mt-2 px-3" href="">Read More <i class="fa fa-angle-right"></i></a>
        </div>
    </div>
