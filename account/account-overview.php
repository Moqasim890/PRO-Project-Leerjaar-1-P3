...
<head>
    ...
    <style>
        /* Extra spacing to move content further down */
        .content-spacing {
            margin-top: 120px;
            /* Adjust this value to move it even further */
        }
    </style>
</head>
            ...
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="card border-0 bg-secondary text-white text-center p-3">
                        ...
                        <p class="text-muted">Member since <?php output_created(); ?></p>
                        <hr class="bg-light">
                        <ul class="list-unstyled text-left">
                            <li class="py-2"><i class="fa fa-user text-primary mr-2"></i> <a href="#"
                                    class="text-white">Profile</a></li>
                            <li class="py-2"><i class="fa fa-id-card text-primary mr-2"></i> <a href="#"
                                    class="text-white">Membership</a></li>
                            <li class="py-2"><i class="fa fa-chart-line text-primary mr-2"></i> <a href="#"
                                    class="text-white">Progress</a></li>
                            <li class="py-2"><i class="fa fa-cog text-primary mr-2"></i> <a href="#"
                                    class="text-white">Settings</a></li>
                            <li class="py-2"><i class="fa fa-sign-out-alt text-danger mr-2"></i> <a href="logout.php"
                                    class="text-danger">Logout</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="col-md-9">
                    <div class="card border-0 shadow-sm p-4">
                        <h3 class="font-weight-bold mb-4">Account Overview</h3>
                        ...
                        <div class="mb-4">
                            ...
                            <p><strong>Last Workout:</strong> February 10, 2025</p>
                            <p><strong>Calories Burned:</strong> 850 kcal</p>
                            <div class="progress">
                            ...
                            <a href="#" class="btn btn-outline-primary btn-sm mt-2">View Progress</a>
                        </div>
                        ...
                        <!-- Billing Info -->
                        <div class="mb-4">
                            <h5 class="text-primary font-weight-bold">Billing Information</h5>
                        ...
                        <!-- Account Settings -->
                        <div>
                            <h5 class="text-primary font-weight-bold">Account Settings</h5>
